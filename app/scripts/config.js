...
function configState($stateProvider, $urlRouterProvider, $compileProvider, $authProvider, GooglePlusProvider) {
    $authProvider.loginUrl = 'http://reservaslab.com/auth_login';
    
    GooglePlusProvider.init({
      clientId: '282048781749-nbkin7e7j3mn18lvvbf4pru3ptg8ltf7.apps.googleusercontent.com',
      apiKey: 'Zyytc2eFr_pDy-OHPDMLQg-I',
...
angular
    .module('homer')
    .config(configState)
    .run(function($rootScope, $state, editableOptions, $location) {
